 ...
 */
public class Physiotherapeute extends ProfSantePhysique {
    ...
    /*  Constructeur.  */
    /**
     * Physiotherapeute est un Professionnel specialise en sante physique
     ...
     */
    public Physiotherapeute(String nom, String adresse, String ville, String province,
        ...
        if(this.getNumero() != 0) { this.type = "Physiotherapeute"; }
    }
