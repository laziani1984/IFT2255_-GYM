 ...
 */
public class EntraineurPersonnel extends ProfExerPhysique {
    ...
    /*  Constructeur.  */
    /**
     * EntraineurPersonnel est un Professionnel specialise en Exercice physique
     ...
     */
    public EntraineurPersonnel(String nom, String adresse, String ville,
        ...
        if(this.getNumero() != 0) { this.type = "Entraineur personnel"; }
    }
