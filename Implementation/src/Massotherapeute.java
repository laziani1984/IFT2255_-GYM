 ...
 */
public class Massotherapeute extends ProfSantePhysique {
    ...
    /*  Constructeur.  */
    /**
     * Massotherapeute est un Professionnel specialise en sante physique
     ...
     */
    public Massotherapeute(String nom, String adresse, String ville, String province,
        ...
        if(this.getNumero() != 0) { this.type = "Massotherapeute"; }
    }
