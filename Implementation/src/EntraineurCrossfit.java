 ...
 */
public class EntraineurCrossfit extends ProfExerPhysique {
    ...
    /*  Constructeur.  */
    /**
     * EntraineurCrossfit est un Professionnel specialise en Exercice physique
     ...
     */
    public EntraineurCrossfit(String nom, String adresse, String ville,
        ...
        if(this.getNumero() != 0) { this.type = "Entraineur Crossfit"; }
    }
